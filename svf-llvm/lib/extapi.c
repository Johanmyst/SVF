...
{
    return (const unsigned short **)STATIC_OBJECT;
}

int **__ctype_tolower_loc(void)
{
    return (int **)STATIC_OBJECT;
}
...
{
    return (void *)STATIC_OBJECT;
}

char *asctime(const void *timeptr)
{
    return (char *)STATIC_OBJECT;
}
...
{
    return (struct group *)STATIC_OBJECT;
}
...
{
    return (struct hostent *)STATIC_OBJECT;
}
...
{
    return (struct mntent *)STATIC_OBJECT;
}

struct protoent *getprotobyname(const char *name)
{
    return (struct protoent *)STATIC_OBJECT;
}
...
{
    return (struct passwd *)STATIC_OBJECT;
}
...
{
    return (struct servent *)STATIC_OBJECT;
}
...
{
    return (struct spwd *)STATIC_OBJECT;
}
...
{
    return (struct tm *)STATIC_OBJECT;
}

const char *gnu_get_libc_version(void)
{
    return (const char *)STATIC_OBJECT;
}
...
{
    return (struct lconv *)STATIC_OBJECT;
}
...
/** Define (re)allocation functions for common external libraries & tools, like PerlBench, aom, bzip, etc */
...
__attribute__((annotate("ALLOC_RET"), annotate("AllocSize:Arg0")))
void *aom_malloc(unsigned long size)
{
    return (void *)NULL;
}

__attribute__((annotate("ALLOC_RET"), annotate("AllocSize:Arg0*Arg1")))
void *aom_calloc(unsigned long nitems, unsigned long size)
{
    return (void *)NULL;
}

__attribute__((annotate("ALLOC_RET"), annotate("AllocSize:Arg1")))
void* aom_memalign(unsigned long size1, unsigned long size2)
{
    return (void *)NULL;
}

__attribute__((annotate("MEMSET")))
void *aom_memset(void* dst, int val, unsigned long len)
{
    return (void *)NULL;
}
